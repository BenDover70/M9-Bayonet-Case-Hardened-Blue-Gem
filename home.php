...
<div class="container px-0 mt-5">
  <div class="row justify-content-center gx-4 gy-4">
        ...
        <!-- Mines -->
            <div class="col-md-3">
                <div class="p-0 border bg-light rounded-4 shadow d-flex flex-column overflow-hidden" style="height: 570px; background-image: url('pictures/mines-bnr.webp'); background-size: cover; background-position: center;">
                    <!-- Dunkler Hintergrundbereich oben -->
                    <div class="text-white text-center d-flex flex-column justify-content-center align-items-center" style="background: rgba(0, 0, 0, 0.6); height: 160px; padding: 1.5rem;">
                        <h2 class="mb-2">Mines</h2>
                        <p class="mb-0">Hier Mines spielen!!</p>
                    </div>
                    ...
                    <!-- Button -->
                    <div class="text-center mb-3">
                        <a href="index.php?page=mines">
                            <button class="btn btn-success">Zum Minen-Gefächt!</button>
                        </a>
                    </div>
                </div>
            </div>     
