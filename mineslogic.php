...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const chipCountEl = document.getElementById('chips-general');
  ...
  boxes.forEach((box, i) => {
    box.addEventListener('click', () => {
      if (gameOver || box.classList.contains('safe') || box.classList.contains('mine')) return;
      if (currentBet === 0) {
